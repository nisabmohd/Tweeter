...
import bg from '../assets/Tweetstorm-bro1.svg'
...
export default function Signup(props) {
    ...
    return (
        <div className='loginpage' style={{ height: '85vh', display: 'flex', width: '100%', backgroundImage: `url(${bg})`, backgroundRepeat: 'no-repeat', justifyContent: 'space-evenly', alignItems: 'center', backgroundSize: '650px'}}>
            <div className="" style={{ borderRadius: '9px', padding: '29px', backgroundColor: 'rgb(33 35 36)', height: 'fit-content', paddingTop: '35px', paddingBottom: '25px', width: 'fit-content', margin: 'auto',marginTop:'7.5vh'}}>
                <Toaster />
                <div className="forms" style={{}}>
                    <div className="header">
                        <h3 style={{ marginTop: '-5px', marginBottom: '35px', color: 'white' }}>Sign Up</h3>
                    </div>
                    ...
                    <label htmlFor="imgup">
                        <div className="image" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', cursor: 'pointer' }}>
                            ...
                            <p style={{ fontSize: "13.5px", color: 'white' }}>Change Photo</p>
                        </div>
                    </label>
                    <div className="name">
                        <p style={{ fontSize: "13.5px", marginBottom: "5px", color: 'white' }}>Name *</p>
                        <TextField
                            hiddenLabel
                    ...
                    <div className="email">
                        <p style={{ fontSize: "13.5px", marginBottom: "5px", color: 'white' }}>Email *</p>
                        <TextField
                            type="email"
                            hiddenLabel
                            id="filled-hidden-label-small"
                    ...
                    <div className="cover">
                        <p style={{ fontSize: "13.5px", marginBottom: "5px", color: 'white' }}>Cover Image url</p>
                        <TextField
                            type="email"
                            hiddenLabel
                            id="filled-hidden-label-small"
                    ...
                    <div className="bio">
                        <p style={{ fontSize: "13.5px", marginBottom: "5px", color: 'white' }}>Bio</p>
                        <TextField
                            hiddenLabel
                    ...
                    <div className="password">
                        <p style={{ fontSize: "13.5px", marginBottom: "5px", color: 'white' }}>Create Password *</p>
                        <TextField
                            type="password"
                            hiddenLabel
                            id="filled-hidden-label-small"

...
export default function Whotofollow(props) {
    ...
    return (
        users.length?<div style={{ backgroundColor: 'white', padding: '11px', borderRadius: '9px', display: 'flex', flexDirection: 'column', marginLeft: props.marginleft, marginTop: props.mtop }
        }>

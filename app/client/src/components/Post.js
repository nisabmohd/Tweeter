    ...
    return (
        <div style={{backgroundColor: 'white', borderRadius: '9px', marginBottom: '15px', paddingBottom:'15px'}}>
            <Link to={`/post/postid=${props.postid}`} style={{ textDecoration: 'none', color: 'inherit' }} >
                <div className='post' style={{padding: '12px', backgroundColor: 'white', borderRadius: '9px' }}>
            ...
            <div className="actionbuttons" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '85%', margin: 'auto', marginTop: '19px' }}>
